...
export default function CTASection() {
  return (
    <section className="relative py-20 lg:py-32 bg-gradient-to-b from-white to-slate-50/50 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#001A2C] mb-8 leading-tight">
            Ingin Media Anda Menjadi Bagian dari Kami?
          </h2>

          <p className="text-xl text-slate-600 mb-12 max-w-2xl mx-auto">
            Bergabunglah dengan ribuan mitra media yang telah bertransformasi bersama Promedia Teknologi
          </p>
