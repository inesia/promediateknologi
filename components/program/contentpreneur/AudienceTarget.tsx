...
const personas = [
  {
    ...
    description: 'Baru lulus dan mencari peluang untuk mengembangkan skill menulis sambil menghasilkan pendapatan',
    icon: GraduationCap,
  ...
  },
  {
    id: 'hobby-writer',
    title: 'Hobby Writer',
    description: 'Pecinta menulis yang ingin mengubah hobi menjadi sumber penghasilan tambahan',
    icon: BookOpen,
  ...
  },
  {
    id: 'freelancer',
    title: 'Freelancer',
    description: 'Writer freelance yang ingin bergabung dengan jaringan media profesional untuk meningkatkan portofolio',
    icon: Briefcase,
    color: 'from-[#00AEEF] to-[#2D74B3]',
    avatar: '💼',
  },
