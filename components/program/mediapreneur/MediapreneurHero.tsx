...
import { ArrowRight, FileText, Eye, Wallet, Globe } from 'lucide-react'
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              ...
              <motion.div
                key={i}
                className="bg-gradient-to-br bg-slate-50 rounded-xl p-4 border border-slate-200 flex items-center justify-center aspect-[4/3]"
