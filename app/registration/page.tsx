  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex min-h-[calc(100vh-80px)] pt-20">
        ...
        >
          {/* Gradient Background with Slow Wave Animation */}
          <div className="absolute inset-0 bg-gradient-to-br from-[#00AEEF] via-[#2D74B3] to-[#001A2C]">
            {/* Slow Wave Animation */}
            <motion.div
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all ${
                  index === testimonialIndex ? 'bg-white w-8' : 'bg-white/50'
                }`}
              />
            ))}
          </div>
        ...
        <div className="w-full lg:w-[60%] bg-white flex items-center justify-center p-6 lg:p-12">
                      ...
                      return (
                        <motion.button
                          ...
                          className={`w-full p-6 rounded-xl border-2 transition-all text-left ${
                            isSelected
                              ? 'border-[#00AEEF] bg-[#00AEEF]/5 shadow-lg'
      ...
      <div className="lg:hidden relative overflow-hidden bg-gradient-to-br from-[#00AEEF] via-[#2D74B3] to-[#001A2C] py-12 px-6">
